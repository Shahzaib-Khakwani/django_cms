...
class CourseViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    @action(detail=True, methods=['get'], authentication_classes= [BasicAuthentication], permission_classes = [IsAuthenticated, isEnrolled], serializer_class = CourseWithContentSerializer)
