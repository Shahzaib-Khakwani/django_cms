...
class OwnerCourseMixin(OwnerMixin, LoginRequiredMixin, PermissionRequiredMixin):
    model = Course
    fields = ['subject', 'title', 'slug', 'overeview']
...
class ModuleContentCreateUpdateView(TemplateResponseMixin, View):
    module = None
    model = None
    obj = None
...
class CourseModuleListView(TemplateResponseMixin, View):
